...
export const config = {
    ...
    api_over_7 :"release_date.gte=1980&vote_count.gte=400&vote_average.gte=7&with_watch_monetization_types=flatrate",
    ...
    api_top_tv_popularity: "&language=en-US&sort_by=popularity.desc&timezone=America%2FNew_York&include_null_first_air_dates=false&with_watch_monetization_types=flatrate&with_status=0&with_type=0",
    api_top_tv_rating: "&language=en-US&sort_by=vote_average.desc&page=1&vote_count.gte=10&include_null_first_air_dates=false&with_watch_monetization_types=flatrate&with_status=0&with_type=0"
}
