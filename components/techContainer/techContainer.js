...
import prismicIcon from "../../public/icons/Prismic.svg";
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.techContainer}>
        <TechBox techLogo={jsIcon} techName="Javascript" />
        <TechBox techLogo={reactIcon} techName="React" />
        <TechBox techLogo={sassIcon} techName="sass" />
        <TechBox techLogo={htmlIcon} techName="html" />
        <TechBox techLogo={gitIcon} techName="git" />
        <TechBox techLogo={cssIcon} techName="css" />
        <TechBox techLogo={nextJsIcon} techName="next js" />
        <TechBox techLogo={tailwindIcon} techName="Tailwind CSS" />
        <TechBox techLogo={prismicIcon} techName="Prismic" />
      </div>
      <p className={styles.text}>
        {"Technologies I'm currently familiarizing myself with: "}
      </p>
      <div className={styles.techContainer}>
        <TechBox techLogo={tsIcon} techName="typescript" />
      </div>
    </div>
  );
}
